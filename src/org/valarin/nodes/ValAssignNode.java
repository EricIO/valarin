...
public abstract class ValAssignNode extends ValExpressionNode {
    ...
    protected boolean isLong() {
        return this.isKind(this.getFrameSlot(), FrameSlotKind.Long);
    }
    
    protected boolean isBoolean() {
        return this.isKind(this.getFrameSlot(), FrameSlotKind.Boolean);
    }
    
    protected boolean isDouble() {
        return this.isKind(this.getFrameSlot(), FrameSlotKind.Double);
    }
